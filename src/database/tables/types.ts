...
export type PgUserBillingInformationSelectType = typeof userBillingInformationsTable.$inferSelect
...
export type PgUserShippingInformationSelectType = typeof userShippingInformationTable.$inferSelect
...
export type PgUserBillingInformationInsertType = typeof userBillingInformationsTable.$inferInsert
...
export type PgUserShippingInformationInsertType = typeof userShippingInformationTable.$inferInsert

// -- Product Select Types
export type PgProductSelectType = typeof productsTable.$inferSelect
export type PgProductAttributeSelectType = typeof productAttributesTable.$inferSelect
...
export type PgProductCategorySelectType = typeof productCategoriesTable.$inferSelect
export type PgProductVariationSelectType = typeof productVariationsTable.$inferSelect

// -- Product Insert Types
export type PgProductInsertType = typeof productsTable.$inferInsert
export type PgProductAttributeInsertType = typeof productAttributesTable.$inferInsert
...
export type PgProductCategoryInsertType = typeof productCategoriesTable.$inferInsert
export type PgProductVariationInsertType = typeof productVariationsTable.$inferInsert
...
export type PgPaymentProviderSelectType = typeof paymentProvidersTable.$inferSelect

// -- Payment Insert Types
export type PgTransactionInsertType = typeof transactionTable.$inferInsert
export type PgPaymentProviderInsertType = typeof paymentProvidersTable.$inferInsert
